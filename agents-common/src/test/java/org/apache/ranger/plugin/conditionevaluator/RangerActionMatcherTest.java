...
public class RangerActionMatcherTest {
    ...
    public void testNullOrEmptyConditionMatchesAll() {
        ...
        Assertions.assertTrue(matcherNull.isMatched(createRequest("PutObject")));
        Assertions.assertTrue(matcherNull.isMatched(createRequest(null)));

        final RangerActionMatcher matcherEmpty = createMatcher(new String[] {});

        Assertions.assertTrue(matcherEmpty.isMatched(createRequest("PutObject")));
        Assertions.assertTrue(matcherEmpty.isMatched(createRequest(null)));
    }
    ...
    public void testWildcardMatchesAll() {
        ...
        Assertions.assertTrue(matcher.isMatched(createRequest("GetObject")));
        Assertions.assertTrue(matcher.isMatched(createRequest("PutObject")));
        Assertions.assertTrue(matcher.isMatched(createRequest(null)));
    }
    ...
    public void testNoRequestActionDoesNotEnforce() {
        ...
        Assertions.assertTrue(matcher.isMatched(createRequest(null)));
        Assertions.assertTrue(matcher.isMatched(createRequest("")));
        Assertions.assertTrue(matcher.isMatched(createRequest("   ")));
    }
    ...
    public void testExactMatchCaseInsensitive() {
        ...
        Assertions.assertTrue(matcher.isMatched(createRequest("GetObject")));
        Assertions.assertTrue(matcher.isMatched(createRequest("getobject")));
        Assertions.assertFalse(matcher.isMatched(createRequest("PutObject")));
    }
    ...
    public void testTrailingWildcardPrefixMatchCaseInsensitive() {
        ...
        Assertions.assertTrue(matcher.isMatched(createRequest("PutObject")));
        Assertions.assertTrue(matcher.isMatched(createRequest("putobjecttagging")));
        Assertions.assertFalse(matcher.isMatched(createRequest("GetObject")));
    }
